...
def log_metrices(opt):
    ...
    # compute fid
    fid = fid_util.compute_fid_from_numpy(numpy_arr, ref_mu, ref_sigma, mode=opt.mode) # FIXME ValueError for Imaginary components, need more than 2048 samples for computing the convariance matrics
