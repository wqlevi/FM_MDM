# Runner for i2sb diffusion models
...
class Runner_old(object):
    ...
    @util.time_wrap(name="sample_batch")
    ...
    def train(self, opt, train_dataset, val_dataset, corrupt_method):
        ...
        self.accuracy = torchmetrics.Accuracy(task='multiclass', num_classes=1_000).to(opt.device) # kwargs added after torchmetric version 1.3.0
        ...
        for it in range(self.ckpt_iter, opt.num_itr):
            ...
            #print(f"num inner loop: {n_inner_loop}")
    ...
    def evaluation(self, opt, it, val_loader, corrupt_method):
        ...
        log_accuracy("accuracy/clean",   img_clean) #[FIXME] -> line 291
